...
import com.st.st25nfc.type5.st25dv.ST25DVCommandActivity;
...
//            连续两次点击小于0.5秒 退出应用
            if (System.currentTimeMillis() - mLastBackTime < 500){
                ...
                Toast.makeText(this,R.string.tip_double_click_finish,Toast.LENGTH_SHORT).show();
            }
...
//                startTagActivity(ST25DVActivity.class, R.string.st25dv_menus);
                startTagActivity(ST25DVCommandActivity.class, R.string.st25dv_menus);
                break;
