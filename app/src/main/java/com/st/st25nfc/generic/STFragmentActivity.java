...
public class STFragmentActivity extends AppCompatActivity {
    ...
    protected void showToastShort(final String msg) {
        runOnUiThread(new Runnable() {
            public void run() {
                // This function can be called from a background thread so it may happen after the
                // destruction of the activity. In such case, getResmessageources() may be null.

                Toast.makeText(STFragmentActivity.this, msg, Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    protected void showToastLong(final String msg) {
        runOnUiThread(new Runnable() {
            public void run() {
                ...
                Toast.makeText(STFragmentActivity.this, msg, Toast.LENGTH_LONG).show();
            }
        });
    }
